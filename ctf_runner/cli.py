...
def build_parser() -> argparse.ArgumentParser:
    ...
    contest_arm.add_argument("--allow-live-submit", action="store_true")
    ...
    contest_start_workers.add_argument("--live-submit", action="store_true")
    contest_start_workers.add_argument("--confirm-submit", action="store_true")
